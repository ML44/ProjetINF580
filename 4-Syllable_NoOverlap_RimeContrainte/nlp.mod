#nlp.mod
param n;#nombre de syllabes
set N = 0..n;
set presqueN = 1..n;
param index{N} symbolic;#ensemble des syllabes
...
var m1{L, N} binary, default 0;#m1[b, i] = 1 ssi la b-ième syllabe du vers 1 est i
var m2{L, N} binary, default 0;#m2[b, i] = 1 ssi la b-ième syllabe du vers 2 est i
